...
class HeapTest {
	...
	/** Return a min-heap with values b and priorities p without using insert. */
	...
	/** Return a max-heap with values b and priorities p without using insert. */
	...
	@Test
	/** Test that inserting integers 0..9 into a min-heap, with priorities same as values, works.<br>
	...
	public void test17insert_BubbleUpDuplicatePriorities() {
		...
		Heap<Integer> mh2= griesHeapify(new Integer[] { 4, 2, 1 },
	...
	public void test31maxBubbledown() {
